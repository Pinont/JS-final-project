...
function GithubIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="inline-block" {...props}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h1 className="font-display font-bold text-4xl md:text-6xl mb-4 text-white tracking-tight">
            Developer <span className="iridescent">Team</span>
          </h1>
            ...
            return (
              ...
              >
                ...
                <div>
                  {/* Contact channels */}
                  {m.id !== "pm" && (
                    <div className="flex justify-center items-center gap-4 mb-6 border-t border-[#1e2230]/50 pt-5">
                      <a
                        href={`https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=${m.email}`}
                        target="_blank"
                        rel="noreferrer"
                        className="text-[#4b5563] hover:text-white transition-colors text-xs font-mono inline-flex items-center gap-1.5"
                        title={m.email}
                      >
